...
namespace DPTeam.UpdateSystem.CoroutineSystem
{
    public class CoroutineManager
    {
        ...
        public void Awake() => Managers.Instance.UpdateManager.UpdateActions.AddAction(PerformUpdate);
        public void OnDestroy() => Managers.Instance.UpdateManager.UpdateActions.RemoveAction(PerformUpdate);
